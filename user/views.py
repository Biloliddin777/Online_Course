...
from user.form import LoginForm, RegisterModelForm, SendingEmailForm
...
class LoginPage(LoginView):
    ...
    template_name = 'online_course/auth/login.html'
...
class RegisterPage(FormView):
    template_name = 'online_course/auth/register.html'
